package org.opencds.cqf.ruler.common.dstu3.provider;
...
import org.opencds.cqf.ruler.common.dstu3.helper.FhirMeasureBundler;
...
public class CqlExecutionProvider {
    ...
    public Bundle evaluate(String code, String patientId, String periodStart, String periodEnd,String productLine, String terminologyServiceUri, String terminologyUser,String terminologyPass, String contextParam, Parameters parameters) {
