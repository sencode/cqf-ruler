package org.opencds.cqf.ruler.core.r4.providers;
...
import org.opencds.cqf.ruler.core.evaluation.LibraryLoader;
...
import org.opencds.cqf.ruler.core.r4.helpers.FhirMeasureBundler;
import org.opencds.cqf.ruler.core.r4.helpers.LibraryHelper;
...
public class CqlExecutionProvider {
    ...
    private Context setupContext(DomainResource instance, String patientId, LibraryLoader libraryLoader,
        ...
        context.registerDataProvider("http://hl7.org/fhir", this.providerFactory.createDataProvider("FHIR",
                this.context.getVersion().getVersion().getFhirVersionString()));
        return context;
    }

    @SuppressWarnings("unchecked")
    public Bundle evaluate(String code, String patientId, String periodStart, String periodEnd, String productLine,
            String terminologyServiceUri, String terminologyUser, String terminologyPass, String contextParam,
            String executionResults, Parameters parameters) {
                    ...
                    if (res == null) {
                        ...
                        if (((List<?>) res).size() > 0 && ((List<?>) res).get(0) instanceof Resource) {
                            if (executionResults != null && executionResults.equals("Summary")) {
                                ...
                                result.addParameter().setName("value")
                                        .setResource(bundler.bundle((Iterable<Resource>) res));
                            }
                        } else {
