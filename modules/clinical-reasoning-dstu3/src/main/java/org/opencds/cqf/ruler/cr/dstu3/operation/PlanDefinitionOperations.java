package org.opencds.cqf.ruler.cr.dstu3.operation;
...
import org.opencds.cqf.ruler.common.dstu3.builder.AttachmentBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.CarePlanActivityBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.CarePlanBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.ExtensionBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.JavaDateBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.ReferenceBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.RelatedArtifactBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.RequestGroupActionBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.RequestGroupBuilder;
import org.opencds.cqf.ruler.common.dstu3.helper.ContainedHelper;
...
public class PlanDefinitionOperations {
    ...
    private ActivityDefinitionOperations activityDefinitionOperations;
                    ...
                    if (action.hasDefinition()) {
                        if (action.getDefinition().getReferenceElement().getResourceType()
                            ...
                            Parameters outParams = this.fhirContext
                                    .newRestfulGenericClient(serverBase).operation()
