package org.opencds.cqf.ruler.cdshooks.r4.servlet;
...
import org.opencds.cqf.ruler.common.r4.provider.JpaTerminologyProvider;
import org.opencds.cqf.ruler.common.retrieve.JpaFhirRetrieveProvider;
import org.opencds.cqf.ruler.cr.r4.operation.PlanDefinitionOperations;
...
public class CdsHooksServlet extends HttpServlet {
    ...
    private org.opencds.cqf.ruler.cr.r4.operation.PlanDefinitionOperations planDefinitionOperations;
    ...
    private org.opencds.cqf.ruler.common.r4.provider.JpaTerminologyProvider jpaTerminologyProvider;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            EvaluationContext<PlanDefinition> evaluationContext = new R4EvaluationContext(hook, version, FhirContext.forR4().newRestfulGenericClient(baseUrl),
    ...
    private JsonObject getServices() {
        DiscoveryResolutionR4 discoveryResolutionR4 = new DiscoveryResolutionR4(
                FhirContext.forR4().newRestfulGenericClient(this.serverBase));
