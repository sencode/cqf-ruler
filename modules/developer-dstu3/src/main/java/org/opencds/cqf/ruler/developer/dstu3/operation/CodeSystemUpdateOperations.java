...
import org.opencds.cqf.ruler.common.dstu3.builder.OperationOutcomeBuilder;
import org.opencds.cqf.ruler.common.dstu3.builder.RandomIdBuilder;
...
@Component
public class CodeSystemUpdateOperations {
    private IFhirResourceDao<ValueSet> valueSetDao;
    private IFhirResourceDao<CodeSystem> codeSystemDao;

    @Inject
    public CodeSystemUpdateOperations(IFhirResourceDao<ValueSet> valueSetDao,
