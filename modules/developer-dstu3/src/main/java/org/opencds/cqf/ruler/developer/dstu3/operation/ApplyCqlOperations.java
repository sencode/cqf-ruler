...
@Component
public class ApplyCqlOperations {
    ...
    @Inject
    public ApplyCqlOperations(EvaluationProviderFactory providerFactory, IFhirResourceDao<Bundle> bundleDao, FhirContext context) {
